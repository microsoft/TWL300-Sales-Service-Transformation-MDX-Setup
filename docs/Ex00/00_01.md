...
{: .note }
> If you cannot delete a demo tenant, [submit a support request](https://cdx.transform.microsoft.com/submit-request) to the MDX support team.

### Key steps

1. On a device that is authorized to run Microsoft corporate resources, open Microsoft Edge and go to [Microsoft MDX](https://mdx.transform.microsoft.com).

1. Sign in by using your Microsoft employee (or V-) credentials.

1. On the command bar, select **Dashboard**.

1. On the Dashboard page, select **Create Tenant**.
...
1. Select **Start demo**. Wait for provisioning to complete.
