...
In this section, you'll deploy the Demo Hub solution template to provision a demo environment for the Sales Transformation with AI workshop.
...
[← Select a workshop](../Ex00/00_03.html){: .btn .mr-2 }
[Configure users and licenses →](02.html){: .btn .btn-purple }
