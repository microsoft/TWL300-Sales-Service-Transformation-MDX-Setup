...
2. In the left pane, select **Setup** and then select **Security**.

3. In the **Security** pane, select **Site visibility**.

    ![ms0b31vm.jpg](../../media/ms0b31vm.jpg)

4. In the **Site visibility** section, select **Public**.

    {: .warning }
    > If you see a message stating that access is restricted, in the **Grant site access** section, enter your administrative credential and then select **Share**.
    >
    > ![h2w92c0t.jpg](../../media/h2w92c0t.jpg)

5. On the message that is displayed, select **Set to public**.
...
8. From the list of agents, select the **Coffee Support Assistant** agent and then select **Connect**.

    {: .note }
    > The Coffee Support Assistant agent is created in the Customer Intent Agent lab. If you have not completed that lab yet, you can return to this step later.
...
[← Import historical data](04.html){: .btn .mr-2 }
[Other prerequisites →](06.html){: .btn .btn-purple }
